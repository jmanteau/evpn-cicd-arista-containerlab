...
| 3 | clab-evpnlab-spine1 | NTP | Synchronised with NTP server | NTP | FAIL | not synchronised to NTP server |
| 4 | clab-evpnlab-spine2 | NTP | Synchronised with NTP server | NTP | FAIL | not synchronised to NTP server |
| 5 | clab-evpnlab-leaf1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet1 - P2P_LINK_TO_CLAB-EVPNLAB-SPINE1_Ethernet1 | PASS |  |
| 6 | clab-evpnlab-leaf1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_CLAB-EVPNLAB-SPINE2_Ethernet1 | PASS |  |
| 7 | clab-evpnlab-leaf1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet3 - h11_Eth1 | PASS |  |
| 8 | clab-evpnlab-leaf1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet4 - h12_Eth1 | PASS |  |
| 9 | clab-evpnlab-leaf2 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet1 - P2P_LINK_TO_CLAB-EVPNLAB-SPINE1_Ethernet2 | PASS |  |
| 10 | clab-evpnlab-leaf2 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_CLAB-EVPNLAB-SPINE2_Ethernet2 | PASS |  |
| 11 | clab-evpnlab-leaf2 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet3 - h21_Eth1 | PASS |  |
| 12 | clab-evpnlab-spine1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet1 - P2P_LINK_TO_CLAB-EVPNLAB-LEAF1_Ethernet1 | PASS |  |
| 13 | clab-evpnlab-spine1 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_CLAB-EVPNLAB-LEAF2_Ethernet1 | PASS |  |
| 14 | clab-evpnlab-spine2 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet1 - P2P_LINK_TO_CLAB-EVPNLAB-LEAF1_Ethernet2 | PASS |  |
| 15 | clab-evpnlab-spine2 | Interface State | Ethernet Interface Status & Line Protocol == "up" | Ethernet2 - P2P_LINK_TO_CLAB-EVPNLAB-LEAF2_Ethernet2 | PASS |  |
| 16 | clab-evpnlab-leaf1 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan110 - Tenant_A_Zone_1 | PASS |  |
| 17 | clab-evpnlab-leaf1 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan111 - Tenant_A_Zone_2 | PASS |  |
| 18 | clab-evpnlab-leaf1 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan210 - Tenant_A_Zone_3 | PASS |  |
| 19 | clab-evpnlab-leaf1 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan211 - Tenant_A_Zone_4 | PASS |  |
| 20 | clab-evpnlab-leaf2 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan110 - Tenant_A_Zone_1 | PASS |  |
| 21 | clab-evpnlab-leaf2 | Interface State | Vlan Interface Status & Line Protocol == "up" | Vlan111 - Tenant_A_Zone_2 | PASS |  |
| 22 | clab-evpnlab-leaf1 | Interface State | Vxlan Interface Status & Line Protocol == "up" | Vxlan1 | PASS |  |
| 23 | clab-evpnlab-leaf2 | Interface State | Vxlan Interface Status & Line Protocol == "up" | Vxlan1 | PASS |  |
| 24 | clab-evpnlab-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | PASS |  |
| 25 | clab-evpnlab-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback1 - VTEP_VXLAN_Tunnel_Source | PASS |  |
| 26 | clab-evpnlab-leaf1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback100 - Tenant_B_Zone_VTEP_DIAGNOSTICS | PASS |  |
| 27 | clab-evpnlab-leaf2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | PASS |  |
| 28 | clab-evpnlab-leaf2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback1 - VTEP_VXLAN_Tunnel_Source | PASS |  |
| 29 | clab-evpnlab-leaf2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback100 - Tenant_A_Zone_VTEP_DIAGNOSTICS | PASS |  |
| 30 | clab-evpnlab-spine1 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | PASS |  |
| 31 | clab-evpnlab-spine2 | Interface State | Loopback Interface Status & Line Protocol == "up" | Loopback0 - EVPN_Overlay_Peering | PASS |  |
| 32 | clab-evpnlab-leaf1 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet1 - remote: clab-evpnlab-spine1_Ethernet1 | PASS |  |
| 33 | clab-evpnlab-leaf1 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: clab-evpnlab-spine2_Ethernet1 | PASS |  |
| 34 | clab-evpnlab-leaf2 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet1 - remote: clab-evpnlab-spine1_Ethernet2 | PASS |  |
| 35 | clab-evpnlab-leaf2 | LLDP Topology | lldp topology - validate peer and interface | local: Ethernet2 - remote: clab-evpnlab-spine2_Ethernet2 | PASS |  |
...
| 72 | clab-evpnlab-leaf1 | Routing Table | Remote Lo0 address | 192.168.255.30 | PASS |  |
