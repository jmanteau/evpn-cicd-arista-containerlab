...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 172.100.100.12/24 | 127.0.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CLAB-EVPNLAB-LEAF1_Ethernet2 | routed | - | 172.31.255.2/31 | default | 9000 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CLAB-EVPNLAB-LEAF2_Ethernet2 | routed | - | 172.31.255.6/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CLAB-EVPNLAB-LEAF1_Ethernet2
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_CLAB-EVPNLAB-LEAF2_Ethernet2
   no shutdown
   mtu 9000
   no switchport
...
router bgp 65001
   ...
   neighbor 172.31.255.3 description clab-evpnlab-leaf1_Ethernet2
   neighbor 172.31.255.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.7 remote-as 65102
   neighbor 172.31.255.7 description clab-evpnlab-leaf2_Ethernet2
